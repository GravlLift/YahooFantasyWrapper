...
namespace YahooFantasyWrapper.Models.Response
{
    ...
    public class PlayerOwnershipStatus : StringEnum
    {
        ...
        public static PlayerOwnershipStatus Waivers => new("W");
        public static PlayerOwnershipStatus Taken => new("T");
        public static PlayerOwnershipStatus Keepers => new("K");
    }
    ...
    public class PlayerSortType : StringEnum
    {
        ...
        public static PlayerSortType LastMonth => new("lastmonth");
    }
}
