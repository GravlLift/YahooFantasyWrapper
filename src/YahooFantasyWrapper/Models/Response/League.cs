...
namespace YahooFantasyWrapper.Models.Response
{
    ...
    {
        [XmlElement(
            ElementName = "league_key",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public string LeagueKey { get; set; }
        [XmlElement(
            ElementName = "league_id",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        ...
        [XmlElement(
            ElementName = "draft_status",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public string DraftStatus { get; set; }
        [XmlElement(
            ElementName = "num_teams",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public string NumTeams { get; set; }
        [XmlElement(
            ElementName = "edit_key",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public string EditKey { get; set; }
        [XmlElement(
            ElementName = "weekly_deadline",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public string WeeklyDeadline { get; set; }
        [XmlElement(
            ElementName = "league_update_timestamp",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        ...
        [XmlElement(
            ElementName = "short_invitation_url",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public string ShortInvationUrl { get; set; }
        [XmlElement(
            ElementName = "allow_add_to_dl_extra_pos",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public bool AllowAddToDlExtraPos { get; set; }
        [XmlElement(
            ElementName = "is_pro_league",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public bool IsProLeague { get; set; }
        [XmlElement(
            ElementName = "is_cash_league",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public bool IsCashLeague { get; set; }
        [XmlElement(
            ElementName = "current_week",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public int CurrentWeek { get; set; }
        [XmlElement(
            ElementName = "start_week",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        ...
        [XmlElement(
            ElementName = "standings",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public Standings Standings { get; set; }
        [XmlElement(
            ElementName = "scoreboard",
            Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
